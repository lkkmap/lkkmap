...
})("g-map-black-box", {namespace: "g-", setup: window.setupInteractive || window.getComponent});
...
})("g-map-en-box", {namespace: "g-", setup: window.setupInteractive || window.getComponent});